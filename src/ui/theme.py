...
def tokens() -> dict[str, object]:
    ...
    return {
        "bg": f"hsl({neutral_hue}, 32%, {config['bg_lightness']}%)",
        "surface": f"hsla({neutral_hue}, 26%, 12%, {config['glass_opacity']})",
        "surface_hi": f"hsl({neutral_hue}, 24%, 16%)",
        "outline": f"hsl({neutral_hue}, 18%, 24%)",
        "accent": f"hsl({config['brand_hue']}, 76%, 48%)",
        "energy": f"hsl({config['energy_hue']}, 85%, 54%)",
        "interactive": f"hsl({config['accent_hue']}, 78%, 58%)",
        "info": f"hsl({config['data_hue']}, 80%, 62%)",
        "positive": "hsl(148, 64%, 48%)",
        "warn": "hsl(38, 90%, 58%)",
        "text": "hsl(210, 32%, 96%)",
        "muted": "hsl(214, 16%, 68%)",
